...
public class Banana extends Fruit{
    private final static String BANANA_IMAGE = "Home/resources/banana.png";
    private final static String BANANA_SLICED_IMAGE_1 = "Home/resources/banana_sliced1.png";
    private final static String BANANA_SLICED_IMAGE_2 = "Home/resources/banana_sliced2.png";
    ...
    public void moveSliced() {
        for (ImageView bananaSliced11 : bananaSliced1) {
            bananaSliced11.setLayoutY(bananaSliced11.getLayoutY() + 3);
            bananaSliced11.setRotate(bananaSliced11.getRotate() - (randomPositionGenerator.nextInt((5 - 2) + 1) + 2));
            bananaSliced11.setLayoutX(bananaSliced11.getLayoutX() - 1);
        }
        for (ImageView bananaSliced21 : bananaSliced2) {
            bananaSliced21.setLayoutY(bananaSliced21.getLayoutY() + 3);
            bananaSliced21.setRotate(bananaSliced21.getRotate() + randomPositionGenerator.nextInt((5 - 2) + 1) + 2);
            bananaSliced21.setLayoutX(bananaSliced21.getLayoutX() + 1);
        }
    }
    @Override
