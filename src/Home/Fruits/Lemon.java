...
public class Lemon extends Fruit{
    private final static String LEMON_IMAGE = "Home/resources/lemon.png";
    private final static String LEMON_SLICED_IMAGE_1 = "Home/resources/lemon_sliced1.png";
    private final static String LEMON_SLICED_IMAGE_2 = "Home/resources/lemon_sliced2.png";
    ...
    public void moveSliced() {
        for (ImageView lemonSliced11 : lemonSliced1) {
            lemonSliced11.setLayoutY(lemonSliced11.getLayoutY() + 3);
            lemonSliced11.setRotate(lemonSliced11.getRotate() - (randomPositionGenerator.nextInt((5 - 2) + 1) + 2));
            lemonSliced11.setLayoutX(lemonSliced11.getLayoutX() - 1);
        }
        for (ImageView lemonSliced21 : lemonSliced2) {
            lemonSliced21.setLayoutY(lemonSliced21.getLayoutY() + 3);
            lemonSliced21.setRotate(lemonSliced21.getRotate() + randomPositionGenerator.nextInt((5 - 2) + 1) + 2);
            lemonSliced21.setLayoutX(lemonSliced21.getLayoutX() + 1);
        }
    }
    @Override
