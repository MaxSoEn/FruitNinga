...
public class Watermelon extends Fruit{
    private final static String WATERMELON_IMAGE = "Home/resources/watermelon.png";
    private final static String WATERMELON_SLICED_IMAGE_1 = "Home/resources/watermelon_sliced1.png";
    private final static String WATERMELON_SLICED_IMAGE_2 = "Home/resources/watermelon_sliced2.png";
    ...
    public void moveSliced() {
        for (ImageView watermelonSliced11 : watermelonSliced1) {
            watermelonSliced11.setLayoutY(watermelonSliced11.getLayoutY() + 3);
            watermelonSliced11.setRotate(watermelonSliced11.getRotate() - (randomPositionGenerator.nextInt((4 - 2) + 1) + 2));
            watermelonSliced11.setLayoutX(watermelonSliced11.getLayoutX() - 1);
        }
        for (ImageView watermelonSliced21 : watermelonSliced2) {
            watermelonSliced21.setLayoutY(watermelonSliced21.getLayoutY() + 3);
            watermelonSliced21.setRotate(watermelonSliced21.getRotate() + randomPositionGenerator.nextInt((5 - 2) + 1) + 2);
            watermelonSliced21.setLayoutX(watermelonSliced21.getLayoutX() + 1);
        }
    }
